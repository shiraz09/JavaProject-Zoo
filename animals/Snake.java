...
/** Snake is an abstract class that inherits from the LandAnimal class **/
public class Snake extends LandAnimal  implements IReptile {
    ...
    public Snake(String name, Gender gender, double weight, double speed, Medal[] medals, int noLegs, Poisonous poisonous, double length, int size, int id, Location loc, Orientation orien, int maxEnergy, int energyPerMeter, CompetitionPanel pan, BufferedImage img1, BufferedImage img2, BufferedImage img3, BufferedImage img4,String competitionType, int trackNumber) {
        super(name,"Terrest","Snake", gender, weight, speed, medals, noLegs,size,id,loc,orien,maxEnergy,energyPerMeter,pan,img1,img2,img3,img4,competitionType, trackNumber);
        this.poisonous = poisonous;
        this.length = length;
    }

    public Snake(String name,double speed,double energyAmount,double Energy_consumption,double distance){
        this.name=name;
        this.speed=speed;
