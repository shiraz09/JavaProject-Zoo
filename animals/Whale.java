...
/** Whale is an abstract class that inherits from the MarineAnimal class **/
public class Whale extends MarineAnimal {
    ...
    /** The constructor of the Whale class **/
    public Whale(String name,Gender gender, double weight, double speed, double diveDepth, Medal[] medals, String foodType, int size, int id, Location loc, Orientation orien, int maxEnergy, int energyPerMeter, CompetitionPanel pan, BufferedImage img1, BufferedImage img2, BufferedImage img3, BufferedImage img4,String competitionType, int trackNumber) {
        super(name,"Water","Whale", gender, weight, speed, medals, diveDepth,size,id,loc,orien,maxEnergy,energyPerMeter,pan,img1,img2,img3,img4,competitionType, trackNumber);
        this.foodType = foodType;
    }

    public Whale(String name,double speed,double energyAmount,double Energy_consumption,double distance){
        this.name=name;
        this.speed=speed;
